...
module.exports = function (options , module){
	...
	//将当前模块的源替换
	let scopeIdCode = styleModules.scopeId ? '_scopeId:"'+styleModules.scopeId+'",' : '';
	module.code = styleModules.imports.join('\n') + '\n' +
		...
		' = Object.assign(compiled , main , {'+scopeIdCode+'__file:"'+path.dirname(path.relative(options.context, module.filePath))+'",_compiled:true})\n' +
